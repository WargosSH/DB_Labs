...
/*-------------------Task 2.1-----------------*/
CREATE TABLE task9.publishers (
    id INT NOT NULL AUTO_INCREMENT,
    publ_house VARCHAR(256) NOT NULL,
    PRIMARY KEY (id)
);

CREATE TABLE task9.themes (
    id INT NOT NULL AUTO_INCREMENT,
    theme VARCHAR(256) NOT NULL,
    PRIMARY KEY (id)
);

CREATE TABLE task9.categories (
    id INT NOT NULL AUTO_INCREMENT,
    category VARCHAR(256) NOT NULL,
    PRIMARY KEY (id)
);

CREATE TABLE task9.books (
    id INT NOT NULL AUTO_INCREMENT,
    ...
    category_id INT,
    PRIMARY KEY (id),
    FOREIGN KEY (publ_houseID) REFERENCES task9.publishers(id),
    FOREIGN KEY (theme_id) REFERENCES task9.themes(id),
    FOREIGN KEY (category_id) REFERENCES task9.categories(id)
);


/*-------------------Task 2.2-----------------*/
INSERT INTO task9.publishers (publ_house)
SELECT DISTINCT publ_house
FROM task2.books;

INSERT INTO task9.themes (theme)
SELECT DISTINCT theme
FROM task2.books;

INSERT INTO task9.categories (category)
SELECT DISTINCT category
FROM task2.books;

INSERT INTO task9.books(book_code, is_new, name, price, publ_houseID, pages, format, book_date, book_count, theme_id, category_id)
VALUES
